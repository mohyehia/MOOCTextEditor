...
public class EfficientDocument extends Document {
	 ...
	 * alphabetic characters, and false if it contains end of sentence
	 * punctuation.
	 * 
	 * @param tok
	 *            The string to check
	...
	private void processText() {
		...
		// Document. That will come in handy here. isWord defined above will
		// also help.
	 ...
	 * calculate the the number of syllables in a word, it uses the following
	 * rules: Each contiguous sequence of one or more vowels is a syllable, with
	 * the following exception: a lone "e" at the end of a word is not
	 * considered a syllable unless the word has no other syllables. You should
	 * consider y a vowel.
	 * 
	 * Check the examples in the main method below for more information.
	 * 
