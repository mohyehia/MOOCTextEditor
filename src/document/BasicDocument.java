...
public class BasicDocument extends Document {
	...
	/**
	 * Get the number of words in the document. A "word" is defined as a
	 * contiguous string of alphabetic characters i.e. any upper or lower case
	 * characters a-z or A-Z. This method completely ignores numbers when you
	 * count words, and assumes that the document does not have any strings that
	...
	public int getNumWords() {
		// TODO: Implement this method in week 1 according to the comments
		// above.
	...
	/**
	 * Get the total number of syllables in the document (the stored text). To
	 * count the number of syllables in a word, it uses the following rules:
	 * Each contiguous sequence of one or more vowels is a syllable, with the
	 * following exception: a lone "e" at the end of a word is not considered a
	 * syllable unless the word has no other syllables. You should consider y a
	 * vowel.
	 * 
	 * Check the examples in the main method below for more information.
	 * 
	...
	public int getNumSyllables() {
		// TODO: Implement this method in week 1. See the Module 1 support
		// videos
	...
	public static void main(String[] args) {
		 ...
		 * argument to testCase is a Document object, created with the string
		 * shown. The next three arguments are the number of syllables, words
		 * and sentences in the string, respectively. You can use these examples
		 * to help clarify your understanding of how to count syllables, words,
		 * and sentences.
		 */
		testCase(
				new BasicDocument(
